...
{
    // Metoda programatica pentru a face rolurile
    public static class SeedData
    {
        public static void Initialize(IServiceProvider serviceProvider)    // metoda care populeaza baza de date
                                                                           // serviceProvider injecteaza
        {
